...
*DefaultApi* | [**create_file**](docs/DefaultApi.md#create_file) | **POST** /files/files | Createfile
*DefaultApi* | [**delete_file**](docs/DefaultApi.md#delete_file) | **DELETE** /files/files/{file_uuid} | Deletefile
*DefaultApi* | [**get_file**](docs/DefaultApi.md#get_file) | **GET** /files/files/{file_uuid} | Getfile
*DefaultApi* | [**update_file**](docs/DefaultApi.md#update_file) | **PUT** /files/files/{file_uuid} | Updatefile
