...
pub async fn create_staff(configuration: &configuration::Configuration, staff_base: crate::models::StaffBase, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::StaffResponse, Error<CreateStaffError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&staff_base);
...
pub async fn update_staff(configuration: &configuration::Configuration, staff_uuid: &str, staff_base: crate::models::StaffBase, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::StaffResponse, Error<UpdateStaffError>> {
    let local_var_configuration = configuration;
