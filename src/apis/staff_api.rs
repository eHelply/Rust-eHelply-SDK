...
/// struct for typed errors of method [`create_staff`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateStaffError {
    Status404(),
...
pub async fn create_staff(configuration: &configuration::Configuration, staff_create: crate::models::StaffCreate, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::StaffDb, Error<CreateStaffError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/places/staff", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&staff_create);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateStaffError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_staff(configuration: &configuration::Configuration, staff_uuid: &str, soft_delete: Option<bool>, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<serde_json::Value, Error<DeleteStaffError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/places/staff/{staff_uuid}", local_var_configuration.base_path, staff_uuid=crate::apis::urlencode(staff_uuid));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteStaffError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_staff(configuration: &configuration::Configuration, staff_uuid: &str, with_places: Option<bool>, with_companies: Option<bool>, with_catalog: Option<bool>, with_schedule: Option<bool>, with_roles: Option<bool>, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::StaffResponse, Error<GetStaffError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = with_companies {
        local_var_req_builder = local_var_req_builder.query(&[("with_companies", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = with_roles {
        local_var_req_builder = local_var_req_builder.query(&[("with_roles", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetStaffError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn search_staff(configuration: &configuration::Configuration, project_uuid: Option<&str>, first_name: Option<&str>, last_name: Option<&str>, is_deleted: Option<bool>, with_companies: Option<bool>, with_places: Option<bool>, with_schedule: Option<bool>, with_catalog: Option<bool>, with_reviews: Option<bool>, with_roles: Option<bool>, page: Option<i32>, page_size: Option<i32>, sort_on: Option<&str>, sort_desc: Option<bool>, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::Page, Error<SearchStaffError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchStaffError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_staff(configuration: &configuration::Configuration, staff_uuid: &str, staff_create: crate::models::StaffCreate, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::StaffResponse, Error<UpdateStaffError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateStaffError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
