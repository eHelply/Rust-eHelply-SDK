...
/// Creates a tag
pub async fn create_tag(configuration: &configuration::Configuration, tag_base: crate::models::TagBase, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::TagResponse, Error<CreateTagError>> {
...
pub async fn get_tag(configuration: &configuration::Configuration, tag_uuid: &str, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::TagResponse, Error<GetTagError>> {
    let local_var_configuration = configuration;
...
pub async fn update_tag(configuration: &configuration::Configuration, tag_uuid: &str, tag_base: crate::models::TagBase, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::TagResponse, Error<UpdateTagError>> {
    let local_var_configuration = configuration;
