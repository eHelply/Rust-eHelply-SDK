...
pub async fn create_note(configuration: &configuration::Configuration, note_base: crate::models::NoteBase, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::CreateNote200Response, Error<CreateNoteError>> {
