...
/// Creates a category
pub async fn create_category_places_categories_post(configuration: &configuration::Configuration, category_base: crate::models::CategoryBase, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::CategoryResponse, Error<CreateCategoryPlacesCategoriesPostError>> {
...
pub async fn get_category_places_categories_category_uuid_get(configuration: &configuration::Configuration, category_uuid: &str, with_meta: Option<bool>, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::CategoryResponse, Error<GetCategoryPlacesCategoriesCategoryUuidGetError>> {
    let local_var_configuration = configuration;
