...
pub async fn create_file(configuration: &configuration::Configuration, file: std::path::PathBuf, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::CreateFile200Response, Error<CreateFileError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/files/files", local_var_configuration.base_path);
...
pub async fn delete_file(configuration: &configuration::Configuration, file_uuid: &str, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::DeleteFile200Response, Error<DeleteFileError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/files/files/{file_uuid}", local_var_configuration.base_path, file_uuid=crate::apis::urlencode(file_uuid));
...
pub async fn get_file(configuration: &configuration::Configuration, file_uuid: &str, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<std::path::PathBuf, Error<GetFileError>> {
    let local_var_configuration = configuration;
...
pub async fn update_file(configuration: &configuration::Configuration, file_uuid: &str, file: std::path::PathBuf, x_access_token: Option<&str>, x_secret_token: Option<&str>, authorization: Option<&str>, ehelply_active_participant: Option<&str>, ehelply_project: Option<&str>, ehelply_data: Option<&str>) -> Result<crate::models::UpdateFile200Response, Error<UpdateFileError>> {
    let local_var_configuration = configuration;
